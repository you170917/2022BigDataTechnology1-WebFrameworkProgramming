package com.example.homework11_back.config;

import com.example.homework11_back.model.Account;
import com.example.homework11_back.service.AccountService;
...
//                        message.setFrom("2305946142@qq.com"); //设置邮件发送者
//                        message.setTo("3697510023@qq.com","2305946142@qq.com");
//                        //设置邮件接收者,可以有多个接收者
//                        Date date = new Date();
...
//                            helper.setFrom("2305946142@qq.com");
//                            helper.setTo("3697510023@qq.com");
//                            Date date = new Date();
//                            helper.setSentDate(date);
//                            helper.setText("您的账号已于 " + date.toString() + " 进行登录!");
//                            helper.addAttachment("1.jpeg",new
//                                    File("D:\\ideaProgram\\2022BigDataTechnology1-WebFrameworkProgramming\\李佳洁\\homework08\\src\\assets\\1.jpeg"));
                        ...
                        try {
                            ...
                            helper.setText("<p>您的账号已于 " + date.toString() + " 进行登录!</p><img src='cid:p1'/>", true);
                                    helper.addInline("p1",new
                                            FileSystemResource("D:\\ideaProgram\\2022BigDataTechnology1-WebFrameworkProgramming\\李佳洁\\homework08\\src\\assets\\1.jpeg"));
                            javaMailSender.send(mimeMessage);
                        } catch (MessagingException e) {
                            log.error("发送邮件失败: " + e.toString());
                        }
