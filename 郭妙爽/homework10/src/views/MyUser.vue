        ...
        <el-tabs>
          ...
          <el-tab-pane label="查询指定用户" name="second">
            <el-form label-width="80px">
              ...
              <el-form-item>
                <el-button type="primary" v-
                           on:click="getUserById">查询</el-button>
              </el-form-item>
            </el-form>
            <el-table
                :data="userInfo"
          ...
          <el-tab-pane label="添加用户" name="third">
            <el-form label-width="80px">
              ...
              <el-form-item>
                <el-button type="primary" v-on:click="addUser">添加
                </el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label="更新用户" name="fourth">
            <el-form label-width="80px">
              <el-form-item label="ID">
                <el-input v-model="updateUserParams.id" style="width:200px;">
                </el-input> </el-form-item>
              <el-form-item label="用户名">
                <el-input v-model="updateUserParams.username" style="width:200px;">
                </el-input>
              </el-form-item>
              <el-form-item label="地址">
                <el-input v-model="updateUserParams.address" style="width:200px;">
                </el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" v- on:click="updateUser">
                  更新
                </el-button>
              </el-form-item>
            </el-form>
          ...
          <el-tab-pane label="删除用户" name="five">
            <el-form label-width="80px">
              <el-form-item label="用户ID">
                <el-input v-model="deleteId" style="width:200px;">
                </el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" v- on:click="deleteUserById">
                  删除
                </el-button>
              </el-form-item>
            </el-form>
...
export default {
  ...
  methods: {
    ...
    updateUser(){
      ...
      }).then(resp => { if (resp.data.code == 200){
        console.log(resp);
