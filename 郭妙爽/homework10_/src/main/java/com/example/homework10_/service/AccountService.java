package com.example.homework10_.service;

import com.example.homework10_.mapper.AccountMapper;
...
public class AccountService implements UserDetailsService {
    ...
    /*** 1. 先根据用户名拿到账户信息; * 2. 再根据账户信息拿到该账户对应的角色信息 * @param username * @return * @throws UsernameNotFoundException */
    @Override
