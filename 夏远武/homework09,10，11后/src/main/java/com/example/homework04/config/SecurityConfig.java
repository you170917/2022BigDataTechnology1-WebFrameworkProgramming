...
import com.example.homework04.service.AccountService;
        ...
        http.authorizeRequests().anyRequest().authenticated()
                ...
                .successHandler(new AuthenticationSuccessHandler() {
                    ...
                    public void onAuthenticationSuccess(HttpServletRequest
                        ...
                        message.setFrom("2754459193@qq.com"); //设置邮件发送者
                        message.setTo("2754459193@qq.com"); //设置邮件接收者,可以有多个接收者
                        Date date = new Date();
                ...
                .failureHandler(new AuthenticationFailureHandler() {
                    ...
                    public void onAuthenticationFailure(HttpServletRequest
                        ...
                        try {
                            ...
                            helper.setFrom("2754459193@qq.com");
                            helper.setTo("2754459193@qq.com");
                            Date date = new Date();
                            helper.setSentDate(date);
                            helper.setText("<p>您的账号已于 " + date.toString() + " 进行登录!</p><img src='cid:p1'/>", true);
                                    helper.addInline("p1",new
                                            FileSystemResource("\"C:\\Users\\Administrator\\Pictures\\Screenshots\\屏幕截图 2024-04-09 135947.png\""));
