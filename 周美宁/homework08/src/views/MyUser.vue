<template>
  <div>
    <el-container class="app-main-wrap">
      <el-header>
        <div class="title-wrap"><h1 class="title"> 用户管理页面 </h1></div>
      </el-header>
      <el-main>
        <el-tabs>
          <el-tab-pane label="所有用户信息" name="first">
            <el-button type="primary" v-on:click="getAllUsers">刷新</el-button>
          ...
          <el-tab-pane label="查询指定用户" name="second">
            <el-form label-width="80px">
              <el-form-item label="用户ID">
                <el-input v-model="queryId" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item>
          ...
          <el-tab-pane label="添加用户" name="third">
            <el-form label-width="80px">
              <el-form-item label="用户名">
                <el-input v-model="addUserParams.username" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item label="地址">
                <el-input v-model="addUserParams.address" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item>
                <el-button type="primary" v-on:click="addUser">添 加</el-button>
              </el-form-item>
            </el-form>
          </el-tab-pane>
          <el-tab-pane label="更新用户" name="fourth">
            <el-form label-width="80px">
              <el-form-item label="ID">
                <el-input v-model="updateUserParams.id" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item label="用户名">
                <el-input v-model="updateUserParams.username" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item label="地址">
                <el-input v-model="updateUserParams.address" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item>
          ...
          <el-tab-pane label="删除用户" name="five">
            <el-form label-width="80px">
              <el-form-item label="用户ID">
                <el-input v-model="deleteId" style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item>
...
export default {
  name: "MyUser", data() {
    return {
      ...
      queryId: "",
      userInfo: [],
      addUserParams: {username: null, address: null},
      updateUserParams: {id: "", username: "", address: ""},
      deleteId: ""
    }
  }, mounted() {
    this.getAllUsers();
    ...
    deleteUserById() {
      this.deleteRequest("/user", {id: this.deleteId}).then(resp => {
        if (resp.data.code === 200) {
