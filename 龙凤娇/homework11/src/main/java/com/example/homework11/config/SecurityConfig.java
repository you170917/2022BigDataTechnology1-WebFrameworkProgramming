        ...
        http.authorizeRequests().anyRequest().authenticated()
                ...
                .successHandler(new AuthenticationSuccessHandler() {
                    ...
                    public void onAuthenticationSuccess(HttpServletRequest
                        ...
                        message.setFrom("3220856574@qq.com"); //设置邮件发送者
                        message.setTo("2305946142@qq.com"); //设置邮件接收者,可以有多个接收者
                        Date date = new Date();
                        ...
                        /*try {
                            ...
                            helper.setFrom("3220856574@qq.com");
                            helper.setTo("3220856574@qq.com");
                            Date date = new Date();
                            helper.setSentDate(date);
                            helper.setText("您的账号已于 " + date.toString() + " 进行登录!");
                            helper.addAttachment("1.jpeg",new
                                    File("C:\\Users\\32208\\IdeaProjects\\2022BigDataTechnology1-WebFrameworkProgramming\\龙凤娇\\homework08\\src\\assets\\1.jpeg"));
                        ...
                        /*try {
                            ...
                            helper.setText("<p>您的账号已于 " + date.toString() + " 进行登录!</p><img src='cid:p1'/>", true);
                                    helper.addInline("p1",new
                                            FileSystemResource("C:\\Users\\32208\\Pictures\\Camera Roll\\1.jpg"));
                            javaMailSender.send(mimeMessage);
                        } catch (MessagingException e) {
                            log.error("发送邮件失败: " + e.toString());
                        }*/
