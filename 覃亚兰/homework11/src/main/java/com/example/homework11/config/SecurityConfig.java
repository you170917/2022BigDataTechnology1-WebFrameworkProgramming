...
//                            helper.setFrom("3315694298@qq.com");
//                            helper.setTo("2305946142@qq.com");
//                            Date date = new Date();
//                            helper.setSentDate(date);
//                            helper.setText("您的账号已于 " + date.toString() + " 进行登录!");
//                            helper.addAttachment("1.jpg",new
//                                    File("C:\\Users\\Lenovo\\Pictures\\Saved Pictures\\3.jpeg"));
...
//                            helper.setSubject("账户登录提醒");
//                            helper.setFrom("3315694298@qq.com");
//                            helper.setTo("3315694298@qq.com");
//                            Date date = new Date();
//                            helper.setSentDate(date);
//                            helper.setText("<p>您的账号已于 " + date.toString() + " 进行登录!</p><img src='cid:p1'/>", true);
//                                    helper.addInline("p1",new
//                                            FileSystemResource("C:\\Users\\Lenovo\\Pictures\\Saved Pictures\\3.jpeg"));
//                            javaMailSender.send(mimeMessage);
//                        } catch (MessagingException e) {
//                            log.error("发送邮件失败: " + e.toString());
//                        }
