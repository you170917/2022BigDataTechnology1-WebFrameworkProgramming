<template>
  <div>
    <el-form ref="loginForm" v-bind:rules="rules" v-bind:model="loginData" class="loginContainer">
      ...
      <el-form-item label="密码" prop="password">
        <el-input v-model="loginData.password" placeholder="请输入密码..." @keydown.enter.native="submitLogin"></el-input>
      </el-form-item>
      <el-checkbox label="记住我" v-model="checked"></el-checkbox>
      <el-button type="primary" style="width: 100%; margin-top: 5px" v-on:click="submitLogin">登录</el-button>
    </el-form>
  </div>
</template>
<script>
export default {
  ...
  data(){
    return{
      rules: {username:[{required: true, message: "请输入用户名", trigger:
          blur}],
