    ...
    <el-container class="app-main-wrap">
      <el-header>
        <div class="title-wrap">
          <h1 class="title">
            <img src="@/assets/user.png" class="logo" />
            用户管理页面
          </h1>
        </div>
    </el-header>
    <el-main >
        <el-tabs>
            ...
            <el-tab-pane label="查询指定用户" name="second">
                <el-form label-width="80px">
                    <el-form-item label="用户ID" style="width: 200px">
                        <el-input v-model="queryId"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <el-tab-pane label="修改用户" name="fourth">
                ...
                <el-form-item>
                    <el-button type="primary" v-on:click="updateUser">修改</el-button>
                </el-form-item>
            </el-form>
        </el-tab-pane>
