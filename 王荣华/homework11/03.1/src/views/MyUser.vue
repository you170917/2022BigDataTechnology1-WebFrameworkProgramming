    ...
    <el-container class="app-main-wrap">
      <el-header>
        <div class="title-wrap">
          <h1 class="title">
            <img src="../assets/1.jpg" class="logo"  alt=""/>
            用户管理页面
          </h1>
        </div>
      </el-header>
      <el-main >
        <el-tabs>
          <el-tab-pane label="所有用户信息" name="first">
            <el-button type="primary" v-on:click="getAllUser">刷新
            </el-button>
            <el-table
                :data="users"
                style="width: 100%">
          ...
          <el-tab-pane label="添加用户" name="third">
            <el-form label-width="80px">
              <el-form-item label="ID">
                <el-input v-model="addUserParams.id" style="width:200px;"></el-input>
              </el-form-item>
              ...
              <el-form-item label="密码">
                <el-input v-model="addUserParams.password"
                          style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item>
          ...
          <el-tab-pane label="更新用户" name="fourth">
            <el-form label-width="80px">
              ...
              <el-form-item label="密码">
                <el-input v-model="updateUserParams.password"
                          style="width:200px;"></el-input>
              </el-form-item>
              <el-form-item>
