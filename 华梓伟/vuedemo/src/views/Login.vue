  ...
  <div>
    <el-form ref="loginForm" v-bind:rules="rules" v-bind:model="loginData" class="loginContainer">
      ...
      <el-form-item label="密码" prop="password">
        <el-input v-model="loginData.password" v-on:keydown.enter.native="submitLogin" placeholder="请输入密码..."></el-input>
      </el-form-item>
      <el-checkbox label="记住我" v-model="checked"></el-checkbox>
      <el-button type="primary" v-on:click="submitLogin" style="width: 100%; margin-top: 5px">登录</el-button>
    </el-form>
  </div>
</template>
